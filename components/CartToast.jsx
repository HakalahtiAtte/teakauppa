    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-sm flex items-start gap-3 rounded-2xl bg-neutral-900 px-5 py-3 shadow-lg"
          role="status"
          aria-live="polite"
        >
          <span className="flex h-5 w-5 items-center justify-center rounded-full bg-brand shrink-0 mt-0.5">
